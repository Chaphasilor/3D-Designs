...
// Choose between classic hook with screw-holes (false) or "bracket" system (true)
bracket=false; // [false, true]

// Choose between square (false) and round bracket (true)
bracket_round=false; // [false, true]

// Choose to have a second hook (true) or not (false)
second_hook=true; // [true, false]
...
// Choose to have a screw-hole in square bracket (true), or not (false)
safety_screw=false; // [true, false]

// Choose to have the hook's "triangle" extremity (true) or not (false)
extremity=true; // [true, false]

// Choose to have screw-holes (true) or not (false)
screw_holes=true; // [true, false]

// Choose to have the hook's rounded "top" (true) or not (false)
rounded_top=true; // [true, false]
